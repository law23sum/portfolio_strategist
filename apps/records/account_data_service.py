...
from .models import AccountBalance, FinancialTransaction, LinkedAccount
...
class AccountDataService:
    ...
    def get_budget_defaults(user) -> Dict:
        ...
        depository_accounts = LinkedAccount.objects.filter(user=user, status="active", account_type="depository")
    ...
    def get_debt_defaults(user) -> Dict:
        ...
        credit_accounts = LinkedAccount.objects.filter(user=user, status="active", account_type="credit")
        ...
        # Get loan accounts
        loan_accounts = LinkedAccount.objects.filter(user=user, status="active", account_type="loan")
    ...
    def get_investment_defaults(user) -> Dict:
        ...
        investment_accounts = LinkedAccount.objects.filter(
            user=user, status="active", account_type__in=["investment", "brokerage"]
        )
        ...
        retirement_accounts = LinkedAccount.objects.filter(user=user, status="active", account_type="retirement")
        ...
        savings_accounts = LinkedAccount.objects.filter(
            user=user, status="active", account_type="depository", account_subtype__icontains="savings"
        )
