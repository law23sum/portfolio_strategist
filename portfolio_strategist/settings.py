"""
Django settings for The Portfolio Strategist project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-3x9NksKRHiEEYplGmKdzDwiYriOyjxuSsn0T7D8v")
...
ROOT_URLCONF = "portfolio_strategist.urls"
...
WSGI_APPLICATION = "portfolio_strategist.wsgi.application"
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "portfolio_strategist_language"
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="portfolio_strategist-media")
...
EMAIL_SUBJECT_PREFIX = "[The Portfolio Strategist] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "The Portfolio Strategist",
    "DESCRIPTION": "Financia is a financial software (fintech) company that services online users with intuitive, user-friendly financial tools to create, monitor, and advise on budgets, portfolios, and investments, all to promote a simplified, interactive, and reliable approach to easily manage your assets.",
    "VERSION": "0.1.0",
...
WAGTAIL_SITE_NAME = "The Portfolio Strategist Content"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("The Portfolio Strategist"),
    ...
    "CONTACT_EMAIL": "financiasoftwarecompany@gmail.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Christian Dixon", "financiasoftwarecompany@gmail.com")]
